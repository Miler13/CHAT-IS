...
<head>
    ...
    <script src="Cliente/myjava.js"></script>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Cliente</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               <div class="col-md-1"><h4>Buscar:</h4></div>
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el Nombre del Cliente" onkeypress="return sololetras(event)">
		               </div>
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo Cliente</button> 
 ...
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM cliente"));
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-user'></i>&nbsp;&nbsp;Cliente</b></h4>
            </div>
