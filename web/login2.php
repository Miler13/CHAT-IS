                ...
                <div class="panel panel-primary animated flipInY">
                    <div class="panel-heading">
                        <div  style="text-align: center;">
                            <h3 class="panel-title"> <i class="glyphicon glyphicon-off"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Acceso al Chat </h3>  
                        </div>       
                    </div>
                    <div class="panel-body">
                   <div style="text-align: center;">
                       <img src="imagenes/logo2.png" width="200px" height="200px">
                   </div>
                   <br> 
                           <div  style="text-align: center;">
                           <p style="font-weight: bold">Vuelva a Intentar </p>   
